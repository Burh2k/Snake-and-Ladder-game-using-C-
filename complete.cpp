...
cout <<  "-----" << endl;
	...
	PlaySound(TEXT("dice"),NULL, SND_FILENAME);
}
};
...
class Turns {
  ...
  void result()
  {
  	int counter = 30; //amount of seconds
    if (p1 == 100) {
 		cout<<endl;
        cout << "Player 1 " <<getcurrent()<<" has Won!!!"<<endl;
        cout << "Player 1 Total Moves : " << m1<<endl;
        cout << "Player 2 Total Moves : " << m2<<endl;
      }
      if (p2 == 100) {
		cout<<endl;
        cout << "Player 2 " <<getcurrent()<<" has Won!!!"<<endl;
        cout << "Player 1 Total Moves : " << m1<<endl;
        cout << "Player 2 Total Moves : " << m2<<endl;
      }
        Sleep(1000);
...
void board() {
  ...
  cout << "|" << "   " << player1[81] << player2[81] << "  |" << "   " << player1[82] << player2[82] << " |" << "   " << player1[83] << player2[83] << " |" << "   " << player1[84] << player2[84] << " |" << "   " << player1[85] << player2[85] << " |" << "   " << player1[86] << player2[86] << " |" << "   " << player1[87] << player2[87] << " |" << "0/0" << player1[88] << player2[88] << " |" << "   " << player1[89] << player2[89] << " |" << "   " << player1[90] << player2[90] << " |";
  cout << endl << " ----------------------------------------------------------------------" << endl;
  ...
  cout << "|" << "   " << player1[21] << player2[21] << "  |" << " " << player1[22] << player2[22] << "0\\0|" << "   " << player1[23] << player2[23] << " |" << "   " << player1[24] << player2[24] << " |" << "   " << player1[25] << player2[25] << " |" << "   " << player1[26] << player2[26] << " |" << "   " << player1[27] << player2[27] << " |" << "/-/" << player1[28] << player2[28] << " |" << "   " << player1[29] << player2[29] << " |" << "   " << player1[30] << player2[30] << " |";
  cout << endl << " ----------------------------------------------------------------------" << endl;
...
int main() {
 ...
 if(col==189){
  ...
  <<"\t******************************************************"<<endl<<endl<<endl;cout<<"";
  	...
  	PlaySound(TEXT("player1"),NULL, SND_FILENAME);
  	cin >> user;
  	l1.add(user);
  	cout << "Enter Name of PLayer 2" << endl;
  	PlaySound(TEXT("player2"),NULL, SND_FILENAME);
  	cin >> user;
  	l1.add(user);
  	l1.display();
  	Sleep(5000);
